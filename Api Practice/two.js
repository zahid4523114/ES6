...
let myBio = {
  ...
  age: 22,
  profession: { profession: "student", job: "teacher" },
  hobby: ["coding", "eating", "photography"],
};

let getBio = `I am ${myBio.name}.I am ${myBio.age} years old. I works as a ${myBio.profession.job}.My hobby is ${myBio.hobby[0]}`;
console.log(getBio);
